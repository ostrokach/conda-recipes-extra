...
(cd xineramaproto-* && ./configure --prefix=$PREFIX && make -j$NJOBS install) || exit $? 
(cd randrproto-* && ./configure --prefix=$PREFIX && make -j$NJOBS install) || exit $?
(cd compositeproto-* && ./configure --prefix=$PREFIX && make -j$NJOBS install) || exit $?
(cd damageproto-* && ./configure --prefix=$PREFIX && make -j$NJOBS install) || exit $?
...
(cd libXinerama-* && ./configure --prefix=$PREFIX && make -j$NJOBS && make install) || exit $?
...
(cd libXrandr-* && ./configure --prefix=$PREFIX && make -j$NJOBS && make install) || exit $?
(cd libXcursor-* && ./configure --prefix=$PREFIX && make -j$NJOBS && make install) || exit $?
(cd libXcomposite-* && ./configure --prefix=$PREFIX && make -j$NJOBS && make install) || exit $?
(cd libXdamage-* && ./configure --prefix=$PREFIX && make -j$NJOBS && make install) || exit $?
